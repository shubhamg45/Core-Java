...
class CopyConstructorEx11{
	public static void main(String[] args) {
		Address address=new Address("JM ROAD ","DECCAN","PUNE",411005);
		Bank bank=new Bank("SBI ","SBIN000123",123456789l,5000000);

		AmazonPay oldObj=new AmazonPay("RAMESH KUMAR ","ramesh@133",9876543210l,"ramesh123@gmail.com",address,
		...
		System.out.println("CHANGES IN COPY ");
		...
		System.out.println("ORIGNAL OBJECT CHANGES");
		oldObj.displayAmazonPay();
	}
}